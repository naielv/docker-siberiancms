...
class Requirements
{
    ...
    public static function testPhpVersion()
    {
        if (PHP_MAJOR_VERSION === 7 && PHP_MINOR_VERSION === 3) {
            ...
            throw new Exception("PHP 7.3 or >=8.2 is required, see <a target=\"_blank\" href=\"https://doc.siberiancms.com/knowledge-base/siberian-server-requirements/\">siberian-server-requirements</a> for more informations \n");
        }
    }
}
